...
import torch.nn.functional as F #GV ASPP
from torch.nn.parameter import Parameter #GV attention modules
...
# GV BELOW ADDED FROM YOLOV8 BLOCK.PY
class Bottleneck(nn.Module):
    """Standard bottleneck."""
...
#GV - added from other SCB yolov5 paper: https://www.nature.com/articles/s41598-024-59218-w
...
#GV - added from PPA paper:https://www.mdpi.com/2072-4292/15/11/2855
# without BN version
...
## BELOW ADDED FROM YOLOV8 BLOCK.PY
class C2f(nn.Module):
    """Faster Implementation of CSP Bottleneck with 2 convolutions."""
...
# BELOW ADDED FROM https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0310269
### -------------C2f_ScConv---------------start------------- ### 
